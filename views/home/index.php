...
<section class="intro">
	...
	<img src="assets/img/location.jpg" alt="view of the main dining room" class="intro-img">
...
<section class="menu">
	...
	<article>
		<h3>Meat menu</h3>
		<figure>
			<img src="assets/img/meat-menu.jpg" alt="plate with red meat">
			<figcaption>17 $<br>
		...
		<a href="menus.html" class="details">See more</a>
	</article>
	<article>
		<h3>Fish menu</h3>
		<figure>
			<img src="assets/img/fish-menu.jpg" alt="Plate with shrimps and rice">
			<figcaption>19 $<br>
				<span>soft drinks and desert included</span>
				<span>+ taxes</span>
			</figcaption>
	...
	<article>
		...
		<figure>
			<img src="assets/img/vegetarian-menu.jpg" alt="colorfull vegetarian plate">
			<figcaption>18 $<br>
				<span>soft drinks and desert included</span>
				<span>+ taxes</span>
			</figcaption>
